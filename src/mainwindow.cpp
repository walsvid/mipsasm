...
MainWindow::MainWindow()
    : textEdit(new QPlainTextEdit), assemblyText(new QPlainTextEdit)
{
...
//    QFile file("/Users/wen/Desktop/ir.cpp");
...
void MainWindow::compile()
{
    ...
    assemblyText->document()->setPlainText(result);
...
void MainWindow::createActions()
{
    ...
    QToolBar *compileToolBar = addToolBar(tr("Compile"));
    ...
    compileAct->setShortcut(tr("CTRL+D"));
    compileAct->setStatusTip(tr("Compile file"));
    connect(compileAct, &QAction::triggered, this, &MainWindow::compile); //TODO:完成编译的槽函数
